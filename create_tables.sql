...
CREATE TABLE users_subscribers (
    ...
    created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT fk_users_subscribers_user FOREIGN KEY (users_id) REFERENCES users(user_id) ON DELETE CASCADE,
    CONSTRAINT fk_users_subscribers_interest FOREIGN KEY (interests_id) REFERENCES interests(interest_id) ON DELETE CASCADE,
...
CREATE TABLE interests_news_articles (
    interest_news_article_id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
    interests_id UUID NOT NULL,
    news_articles_id UUID NOT NULL,
    created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT fk_interests_news_articles_interest FOREIGN KEY (interests_id) REFERENCES interests(interest_id) ON DELETE CASCADE,
    CONSTRAINT fk_interests_news_articles_news FOREIGN KEY (news_articles_id) REFERENCES news_articles(news_articles_id) ON DELETE CASCADE
);

-- Comments Management table
CREATE TABLE comments_managements (
    comment_management_id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
    user_id UUID,
    ...
    CONSTRAINT fk_comments_managements_news FOREIGN KEY (news_article_id) REFERENCES news_articles(news_articles_id) ON DELETE CASCADE
);
...
CREATE TABLE activity_details (
    activity_detail_id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
    users_id UUID NOT NULL,
    interest_id UUID,
    comment_management_id UUID,
    ...
    created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT fk_activity_details_user FOREIGN KEY (users_id) REFERENCES users(user_id) ON DELETE CASCADE,
    ...
    CONSTRAINT fk_activity_details_news FOREIGN KEY (news_articles_id) REFERENCES news_articles(news_articles_id) ON DELETE SET NULL
);
